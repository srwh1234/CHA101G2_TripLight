...
//                //客服顯示在為誰服務
////                result.put("msg", "正在為用戶"+userInfo.getSessionId()+"服務！");
////                sendMsg(serverInfo.getSession(), JSON.toJSONString(result));
//                sendMsg(serverInfo.getSession(), "正在為用戶"+userInfo.getSessionId()+"服務！");
//                //客戶顯示誰在為他服務
////                result.put("msg", "客服"+serverInfo.getSessionId()+"正在為您服務！");
////                sendMsg(userInfo.getSession(), JSON.toJSONString(result));
//                sendMsg(userInfo.getSession(), "客服"+serverInfo.getSessionId()+"正在為您服務！");
//            }
...
//                Map<String, String> result = new HashMap<>();
//                //客服顯示為誰服務
//                result.put("msg", "正在為客戶"+userInfo.getSessionId()+"服務！");
//                sendMsg(serverInfo.getSession(), JSON.toJSONString(result));
//                //客戶顯示誰在服務
//                result.put("msg", "客服" + serverInfo.getSessionId() + "正在為您服務！");
//                sendMsg(userInfo.getSession(), JSON.toJSONString(result));
