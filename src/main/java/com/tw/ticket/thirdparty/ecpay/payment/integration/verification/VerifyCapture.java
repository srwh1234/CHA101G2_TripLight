...
import com.tw.ticket.thirdparty.ecpay.payment.integration.domain.CaptureObj;
...
public class VerifyCapture extends PaymentVerifyBase {
	...
	public void verifyParams(final CaptureObj obj) {
		final Class<?> cls = obj.getClass();
		Method method;
		String objValue;
		final Element ele = (Element) doc.getElementsByTagName("Capture").item(0);
